# 1 "c:\\users\\lenovo\\desktop\\nuser\\nuser_preorder_viewpreorder\\\\combined_Nuser_preorder_viewpreorder.c"
...
# 1 "c:\\users\\lenovo\\desktop\\nuser\\nuser_preorder_viewpreorder\\\\combined_Nuser_preorder_viewpreorder.c" 2
...
Action()
{
  ...
  lr_start_transaction("S02_Onlinestore_Launch");
	...
	lr_end_transaction("S02_Onlinestore_Launch", 2);
   ...
   web_add_header("Authorization","Bearer {c_Auth}");
	...
	lr_end_transaction("S02_Onlinestore_Login", 2);
...
web_add_header("Authorization","Bearer {c_Auth}");
	...
	lr_end_transaction("S02_Onlinestore_SubmitOtp", 2);
...
web_add_header("Authorization","Bearer {c_Auth}");
	...
	lr_end_transaction("S02_Onlinestore_T01_PreOrder_ClickonPreorder", 2);
...
lr_start_transaction("S02_Onlinestore_T02_PreOrder_ViewPreOrder");
	...
	lr_end_transaction("S02_Onlinestore_T02_PreOrder_ViewPreOrder", 2);
...
web_add_header("Authorization","Bearer {c_Auth}");
	...
	lr_end_transaction("S02_Onlinestore_T03_PreOrder_PaymentPedndingPreOrders", 2);
...
lr_start_transaction("S02_Onlinestore_T04_PreOrder_GoToViewPreOrderDashBoard");
	...
	lr_end_transaction("S02_Onlinestore_T04_PreOrder_GoToViewPreOrderDashBoard", 2);
...
web_add_header("Authorization","Bearer {c_Auth}");
	...
	lr_end_transaction("S02_Onlinestore_T05_PreOrder_ViewOldPreOrders", 2);
...
web_add_header("Authorization","Bearer {c_Auth}");
	...
	lr_end_transaction("S02_Onlinestore_T06_PreOrder_ClickOnDashBoard", 2);


	return 0;
}
# 5 "c:\\users\\lenovo\\desktop\\nuser\\nuser_preorder_viewpreorder\\\\combined_Nuser_preorder_viewpreorder.c" 2
